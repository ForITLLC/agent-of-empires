...
pub use sessions::{
    ...
    get_mcp_surface, get_recent_projects, get_session_goal, kill_terminal, list_sessions,
    paste_image, preview_volume_ignores_globs, read_output, rename_session, restart_session,
    restart_status, restore_session, search_sessions, send_message, serve_session_artifact,
    session_diff_file, session_diff_files, session_file, set_mcp_surface, set_session_goal,
