...
pub use instance::{
    ...
    LifecycleReservationError, PluginCreateIdempotency, SandboxInfo, SessionBucket, StartOutcome,
    Status, TerminalInfo, View, WorkspaceInfo, WorkspaceRepo, WorktreeInfo, SESSION_COLORS,
